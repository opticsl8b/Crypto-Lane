...
var flyBoxCount = 20;
var flyBoxes = [];
var flyBoxPause = 4000;
var flyBoxColors = [];

function setup() {
    createCanvas(windowWidth, windowHeight);
    origin = createVector(windowWidth, windowHeight);
    ...
    var getRandColor = () => {
        return color(random(2000, 3000), random(2000, 3000), random(2000, 3000));
    }
